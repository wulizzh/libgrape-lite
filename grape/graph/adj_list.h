...
struct Nbr {
  ...
  DEV_HOST explicit Nbr(const VID_T& nbr_)
      : neighbor(nbr_), data(), secret(false) {}
  DEV_HOST explicit Nbr(const Vertex<VID_T>& nbr_)
      : neighbor(nbr_), data(), secret(false) {}
  DEV_HOST Nbr(const Nbr& rhs)
      : neighbor(rhs.neighbor), data(rhs.data), secret(rhs.secret) {}
...
struct Nbr<VID_T, EmptyType> {
  ...
  DEV_HOST explicit Nbr(const Vertex<VID_T>& nbr_)
      : neighbor(nbr_), secret(false) {}
  DEV_HOST Nbr(const Nbr& rhs)
      : neighbor(rhs.neighbor), secret(rhs.secret) {}
